...
/* 4 */
/*!**********************************************************!*\
  !*** D:/demo/xiaochengxudemo/xiaochengxudemo/pages.json ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 7 */
/*!***************************************************************************!*\
  !*** D:/demo/xiaochengxudemo/xiaochengxudemo/pages.json?{"type":"style"} ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "定位demo" }, "pages/select/index": { "navigationBarTitleText": "选择城市" } }, "globalStyle": { "navigationBarTextStyle": "white", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#007AFF", "backgroundColor": "#FFFFFF" } };exports.default = _default;

/***/ }),
/* 8 */
/*!**************************************************************************!*\
  !*** D:/demo/xiaochengxudemo/xiaochengxudemo/pages.json?{"type":"stat"} ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 15 */
/*!**************************************************************!*\
  !*** D:/demo/xiaochengxudemo/xiaochengxudemo/store/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var QQMapWX = __webpack_require__(/*! @/static/qqmap-wx-jssdk.min.js */ 20);
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    setCurruntCity: function setCurruntCity(state, data) {
      state.curruntCity = data;
    },
    setCurruntAddress: function setCurruntAddress(state, data) {
      state.curruntAddress = data;
    },
    setSelectAddress: function setSelectAddress(state, data) {
      state.selectAddress = data;
    },
    setSelectCity: function setSelectCity(state, data) {
      state.selectCity = data;
    },
    setLocaltionObj: function setLocaltionObj(state, data) {
    ...
    setResultData: function setResultData(state, data) {
      state.resultData = data;
    } },

  actions: {
    // 获取经纬度
    startLocaltion: function startLocaltion(_ref)
          ...
          uni.getLocation({
            success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                        dispatch('getLocation', {
                          ...
                          longitude: res.longitude });case 1:case "end":return _context.stop();}}}, _callee);}));function success(_x) {return _success.apply(this, arguments);}return success;}(),
                    ...
                    if (res.authSetting['scope.userLocation']) {
                      uni.getLocation({
                        success: function () {var _success2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(res) {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                                    ...
                                    dispatch('getLocation', {
                                      latitude: res.latitude,
                                      longitude: res.longitude });case 2:case "end":return _context2.stop();}}}, _callee2);}));function success(_x2) {return _success2.apply(this, arguments);}return success;}() });
    ...
    // 解析经纬度获取地址信息
    getLocation: function getLocation(_ref2,
    ...
    // 获取该城市下的地域
    getSearchArea: function getSearchArea(_ref3,


    data) {var commit = _ref3.commit,state = _ref3.state;
...
/* 20 */
/*!****************************************************************************!*\
  !*** D:/demo/xiaochengxudemo/xiaochengxudemo/static/qqmap-wx-jssdk.min.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 42 */
/*!**************************************************************!*\
  !*** D:/demo/xiaochengxudemo/xiaochengxudemo/static/city.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
